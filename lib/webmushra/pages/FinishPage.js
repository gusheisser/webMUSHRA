...
FinishPage.prototype.sendResults = function() {
  ...
  try {
    ...
    for (let t of trials) {
      if (t.type === "mushra" && t.responses) {
        for (let r of t.responses) {
          ...
          row = row.concat(participantResponses);
          // Datos del test
    ...
    // === 4. Crear y mostrar botón de descarga ===
    ...
    console.log("✅ Resultados generados con cuestionario incluido.");
  } catch (e) {
