...
FinishPage.prototype.sendResults = function() {
  ...
  try {
    // === Generar CSV manualmente desde session.trials ===
    ...
    link.setAttribute("download", `mushra_results_${this.session.testId || "test"}_${Date.now()}.csv`);
    link.style.visibility = "hidden";
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);

    console.log("✅ Resultados descargados localmente.");
  } catch (e) {
